...
// @version            2.0.0
// @author             Hydrotho
// @description        Enable the GPT-4 Mobile model, ~~thereby overriding GPT-4 usage limits in the ChatGPT web interface~~. It also provides the ability to switch to other models for added flexibility. Generally, this script does not conflict with other popular ChatGPT scripts.
// @description:zh-CN  通过启用 GPT-4 Mobile 模型，~~来解除 ChatGPT 网页端对 GPT-4 模型使用次数的限制~~。同时，它还提供了切换到其他模型的功能，以提供更大的灵活性。一般来说，该脚本不会与其他流行的 ChatGPT 脚本产生冲突。
// @description:zh-TW  通过启用 GPT-4 Mobile 模型，~~来解除 ChatGPT 网页端对 GPT-4 模型使用次数的限制~~。同时，它还提供了切换到其他模型的功能，以提供更大的灵活性。一般来说，该脚本不会与其他流行的 ChatGPT 脚本产生冲突。
// @license            MIT
